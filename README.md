...
- [`multimodal-doc-rag`](https://github.com/ResearchAgents/multimodal-doc-rag): citation-aware multimodal retrieval and context building toolkit.
- [`vlm-eval-lite`](https://github.com/ResearchAgents/vlm-eval-lite): minimal and reproducible multimodal QA evaluation runner.
- [`sparse-vl`](https://github.com/ResearchAgents/sparse-vl): simulation toolkit for visual-token sparsification strategies in VLM inference.
